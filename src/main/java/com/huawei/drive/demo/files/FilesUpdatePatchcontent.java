 ...
 * @since
 */
public class FilesUpdatePatchcontent {
    public static void main(String[] args) throws IOException {
        ...
        JSONObject fileInfo = filesUpdatePatchcontent(url, access_token, fileId);
        System.out.println(fileInfo.toJSONString());
    }

    private static JSONObject filesUpdatePatchcontent(String url, String access_token, String fileId) throws IOException {
        ...
        httpPatch.setHeader("Content-Type", "image/jpeg");
        httpPatch.setHeader("Accept", "application/json");
        httpPatch.setHeader("X-Upload-Content-Type", "image/jpeg");
        //httpPut.setHeader("Content-Length", "115085");

        File file = new File("C:\\Users\\z00502234\\Pictures\\Saved Pictures\\0.jpg");//The path of your local file
        if(!file.exists()){
