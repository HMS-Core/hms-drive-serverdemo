...
public class FilesSubscribe {
    ...
    private static JSONObject filesSubscribe(String url, String access_token, String fileId) throws IOException {
        ...
        jsonParam.put("userToken", "F0Ge56");
        jsonParam.put("url", "https://www.huawei.com");//Only accept https
        //jsonParam.put("expirationTime", "1575362100000");//optional.You can set it in 0-1 day,or use default value.Unix Time
