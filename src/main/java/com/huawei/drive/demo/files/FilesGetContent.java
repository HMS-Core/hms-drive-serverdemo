...
public class FilesGetContent {
    ...
    public static void main(String[] args) throws IOException {
        ...
        filesGetMedia(url, access_token, fileId);
    }

    private static void filesGetMedia(String url, String access_token, String fileId) throws IOException {
        ...
        try {
            ...
            FileUtils.copyToFile(inputStream, new File("D://2.jpg"));
        }finally {
            response.close();
        }
    }
