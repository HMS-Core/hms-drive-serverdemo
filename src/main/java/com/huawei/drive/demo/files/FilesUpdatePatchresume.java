 ...
 * @since
 */
public class FilesUpdatePatchresume {
    public static void main(String[] args) throws IOException {
        ...
        String fileInfo = filesUpdatePatchresume(url, access_token, fileId);
        if(fileInfo != null){
            System.out.println(fileInfo);
        }
    }

    private static String filesUpdatePatchresume(String url, String access_token, String fileId) throws IOException {
        ...
        httpPatch.setHeader("X-Upload-Content-Length", "53");

        JSONObject jsonParam = new JSONObject();
        jsonParam.put("\"appSettings\"", "{    \"test1\": \"value1\"  }");
