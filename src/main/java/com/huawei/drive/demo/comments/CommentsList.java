...
public class CommentsList {
    public static void main(String[] args) throws IOException {
        ...
        JSONObject commentsInfo = commentsList(url, access_token, fileId);
        System.out.println(commentsInfo.toJSONString());
    }

    private static JSONObject commentsList(String url, String access_token, String fileId) throws IOException {
        StringBuilder stringBuilder = new StringBuilder("");
        stringBuilder.append("/").append(fileId).append("/").append("comments");
