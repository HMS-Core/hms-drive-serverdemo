...
public class CommentsGet {
    public static void main(String[] args) throws IOException {
        ...
        JSONObject commentInfo = commentGet(url, access_token, fileId, commentId);
        System.out.println(commentInfo.toJSONString());
    }

    private static JSONObject commentGet(String url, String access_token, String fileId, String commentId) throws IOException {
