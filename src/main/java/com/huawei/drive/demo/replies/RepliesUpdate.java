...
public class RepliesUpdate {
    public static void main(String[] args) throws IOException {
        ...
        JSONObject replyInfo = replyUpdate(url, access_token, fileId, commentId, replyId);
        System.out.println(replyInfo.toJSONString());
    }

    private static JSONObject replyUpdate(String url, String access_token, String fileId, String commentId,
        ...
        stringBuilder.append("/")
            ...
            .append(commentId)
            .append("/")
            .append("replies").append("/").append(replyId);
        ...
        jsonParam.put("description", "2020/02/26 11:20");
