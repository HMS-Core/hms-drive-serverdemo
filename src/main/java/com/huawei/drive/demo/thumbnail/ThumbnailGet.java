...
package com.huawei.drive.demo.thumbnail;
 ...
 * @since
 */
public class ThumbnailGet {
    public static void main(String[] args) throws IOException {

        String url = "https://drive.cloud.hicloud.com/drive/v1/thumbnails";
        ...
        thumbnailGet(url, access_token, fileId);
    }

    private static void thumbnailGet(String url, String access_token, String fileId) throws IOException {
        ...
        try {
            ...
            FileUtils.copyToFile(inputStream, new File("D://thumbnail.jpg"));
        }finally {
            response.close();
        }
    }
